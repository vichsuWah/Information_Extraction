from dataset import Cinnamon_Dataset_v2, DataLoader, tags
...
if __name__=='__main__':
    ...
    ## load dataset
    train_dataset = Cinnamon_Dataset_v2(f'{args.cinnamon_data_path}/train/', tokenizer, tags)
    valid_dataset = Cinnamon_Dataset_v2(f'{args.cinnamon_data_path}/dev/', tokenizer, tags)
